...
<html lang="en">
    ...
    <body>
        ...
        <div class="about-heading">
            <h2>Consultar <span>Solicitud por Producto</span></h2>
        </div>
        <!-- //about-heading -->
            ...
            <div class="container">
                <div class="signin-form profile">
                    ...
                    <div class="login-form">
                        <form action="SolicitudConsultarProdForm.htm" method="post">
                            <table align="center">
                                <tr>
                                    <td>
                                        <br>Tipo de tarjeta:<br>
                                        <select name="idproducto" required="" placeholder="Seleccione el tipo de tarjeta">
