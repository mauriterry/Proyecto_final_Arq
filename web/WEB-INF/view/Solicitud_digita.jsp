...
<%@page import="co.edu.ucatolica.DTOs.Producto"%>
                            ...
                            <div class="signin-form profile">
                                ...
                                <div class="login-form">
                                    <form action="SolicitudRegistrar.htm" method="post">
                                        ...
                                        <input type="text" name="ingMen" placeholder="Ingresos Mensuales" required>
                                        <input type="text" name="ocupacion" placeholder="Ocupacion" required>
                                         <table align="center">
                                             <tr>
                                                    <td >
                                                        <br>Producto:<br>
                                                        <select name="productoidProducto" required="" placeholder="Producto a Solicitar">
                                                            <option value="-1" selected>-Producto a Solicitar-</option>
                                                            <%
                                                                BD cn=new BD();
                                                                try{
                                                                cn.Conectar();
                                            ...
                                            <input type="submit" value="REGISTRAR" onclick="return validateR();">
					</form>
				</div>
				<p>${mensaje}</p>
			</div>
