...
<html lang="en">
    ...
    <body>
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="#" class="dropdown-toggle hvr-sweep-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Reportes<span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="hvr-sweep-to-bottom" href="SolicitudCliente.htm">Solicitudes por cliente</a></li>
                                    </ul>
                                </li> 
                                <li><a href="#" class="dropdown-toggle hvr-sweep-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Aprobar Solicitud de tarjtea<span class="caret"></span></a>
                                    <ul class="dropdown-menu">
        ...
        <div class="about-heading">
            <h2>Editar <span>Solicitud</span></h2>
        </div>
        <!-- //about-heading -->
        <div class="registration">
            <div class="container">
                <div class="signin-form profile">
					...
					<form action="SolicitudEditarForm1.htm" method="post">
                                            <input type="text" name="identificacion1" placeholder="Identificación" required>
                                                                       <table align="center">
                                <tr>
                                    <td >
                                        <br>Producto:<br>
                                        <select name="idprod" required="" placeholder="Producto a Solicitar">
                                            <%
                                                BD cn = new BD();
                                                try {
                                                    cn.Conectar();
                    ...
                    <div class="login-form">
                        <form action="SolicitudEditarForm2.htm" method="post">
                            <input type="text" name="identificacion"  placeholder="Identificacion" value="${listaSolicitud.get(0).getClienteIdPersona()}" readonly="">
                            <input type="text" name="ingMen" placeholder="Ingresos Mensuales" required value="${listaSolicitud.get(0).getIngMen()}">
                            <input type="text" name="ocupacion" placeholder="Ocupacion" required value="${listaSolicitud.get(0).getOcupacion()}">
                            <table align="center">
                                <tr>
                                    <td >
                                        <br>Producto:<br>
                                        <select name="productoidProducto" required="" placeholder="Producto a Solicitar">
                                            <option value="${listaSolicitud.get(0).getProductoidProducto()}">${listaSolicitud.get(0).getNombreproducto()}</option>
                                            <%
                                ...
                                <script Language="JavaScript">
                                    function validateR() {
                                        ...
                                        if (selectedCombobox === "-1") {
                                            alert("Seleccionar Tipo Producto");
                                            return false;
                                        }
                                        return true;
                                    }
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <select name="estado"  placeholder="Estado" >
                                                        <option value="${listaSolicitud.get(0).getEstado()}">${listaSolicitud.get(0).getEstado()}</option>
