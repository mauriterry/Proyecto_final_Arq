...
<html lang="en">
    ...
    <body>
        ...
        <div class="about-heading">
            <h2>Solicitudes  <span>Aprobar</span></h2>
        </div>
        <!-- //about-heading -->
        <div class="registration">
            <div class="table-responsive">                                                               
                <table id="tablaResultado" class="table table-striped table-hover table-bordered" >
                    ...
                    <tbody>
                        <c:forEach var="s" items="${listaSolicitud}">                                           
                            <tr>
                                ...
                                <td><a href="SolicitudAf.htm?pal=${s.getClienteIdPersona()}&pal1=${s.getNombrecliente()}&pal2=${s.getIngMen()}&pal3=${s.getOcupacion()}&pal4=${s.getNombreproducto()}&pal5=${s.getProductoidProducto()}">Aceptar/Rechazar</a></tr>
                            </tr> 
                        </c:forEach>
                    </tbody>
                </table>
